...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='pig',
    ...
    self.parser.add_argument('--demo', default='/home/yangna/deepblue/2_MOT/darknet/scripts/VOCdevkit/VOC2019/JPEGImages/0001.png',
